  ...
  return (
    <PageContainer>
      <div className="text-center mb-10 sm:mb-16 px-4 sm:px-0">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6">Get in Touch</h1>
        <p className="text-[#CCCCCC] text-sm sm:text-base md:text-lg max-w-3xl mx-auto">
        ...
        <div className="space-y-4 sm:space-y-6">
          <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-4 sm:space-y-6">
                {contactInfo.map((item, index) => (
                  <div key={index} className="flex items-start gap-3 sm:gap-4">
                    <div className={`w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center flex-shrink-0 ${index === 0 ? 'bg-blue-900/30' : index === 1 ? 'bg-green-900/30' : index === 2 ? 'bg-purple-900/30' : 'bg-yellow-900/30'}`}>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {item.href ? (
                        <a 
                          ...
                          className="text-blue-400 hover:underline text-sm sm:text-base block mt-0.5 break-words"
                        >
                          {item.value}
                        </a>
                      ) : (
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-xl p-5 sm:p-6 border border-white/10">
              ...
              <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-5">Stay connected with us on social media for the latest updates and news.</p>
              <div className="flex flex-wrap gap-3 sm:gap-4">
                <a
                  href="#"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center group transition-all duration-200 active:scale-95"
                  aria-label="Twitter"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-blue-400 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a
                  ...
                  aria-label="LinkedIn"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-blue-500 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a
                  ...
                  aria-label="GitHub"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-gray-300 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-gray-400 group-hover:text-pink-500 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
